...
3. This project is splitted into 2 parts:
   ...
   2. The main SSA-based compiler: For running the code and test the results, please do > python main.py. For testing the compiler with different test code written in dlx, you can add new files in txt file and save it to the test directory. Then change the file name in main.py.
